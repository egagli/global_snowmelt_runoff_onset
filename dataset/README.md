...
- **v9 (published, frozen — the manuscript dataset).** Zarr v2, 81.10°N–60°S grid (195,970 × 499,998 px), WY2015–2024. Distributed as a `.zarr.tar` on Zenodo — full dataset in record [`19618062`](https://zenodo.org/records/19618062) (`global_snowmelt_runoff_onset.zarr.tar`), per-water-year splits in record [`19699063`](https://zenodo.org/records/19699063) (e.g. `global_snowmelt_runoff_onset_WY2015.zarr.tar`); the manuscript cites DOI [10.5281/zenodo.16953614](https://doi.org/10.5281/zenodo.16953614) (v1.1.0). Azure source of truth: `snowmelt/snowmelt_runoff_onset/global_v9.zarr`. This store stays frozen (it has a DOI).
