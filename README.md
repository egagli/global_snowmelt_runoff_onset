...
| **Sect. 5.1** — station density, "1 station per ~1,280 km² in mountain regions of the Western U.S." | Manuscript value **1,280.7 km² per station** (926 SNOTEL/CCSS stations, old source). **v10 rerun (2026-08-04): 994 stations over 1,191,381 km² = 1,198.6 km² per station** (0.083 stations / 100 km²) — the notebook now uses the same station source as `4_` (usable evaluation stations in `max_snow_pillow_swe_timing.zarr`, WUS-clipped), so **update the manuscript's "~1,280" to "~1,200"** (or keep both, citing the source change) | [`dataset_evaluation/compare_to_all_public_snow_pillows/5_station_density.ipynb`](dataset_evaluation/compare_to_all_public_snow_pillows/5_station_density.ipynb) (moved from `compare_to_snotel/` 2026-08-04) | [`compare_to_all_public_snow_pillows/results/v10/station_density.csv`](dataset_evaluation/compare_to_all_public_snow_pillows/results/v10/station_density.csv) |
